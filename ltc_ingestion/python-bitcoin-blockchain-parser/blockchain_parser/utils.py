...
def decompress_amount(amount_compressed):
    if amount_compressed == 0:
        return 0

    amount_compressed -= 1
    e = amount_compressed % 10
    amount_compressed //= 10;
    

    amount = 0
    if e < 9:
        d = (amount_compressed % 9) + 1
        amount_compressed //= 9
        amount = (amount_compressed * 10) + d
    else:
        amount = amount_compressed + 1
