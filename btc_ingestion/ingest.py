...
block_data_sql =  ( """ REPLACE INTO BLOCK_DATA ( BLOCKCHAIN_CODE, HASH, TRANSACTION_COUNT, HEIGHT,
      DIFFICULTY, DIFFICULTY_SCALE, REWARD, REWARD_SCALE, MERKLE_ROOT, TIMESTAMP, BITS, SIZE,
